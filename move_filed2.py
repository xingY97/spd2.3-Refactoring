...
class Wheel(tpms):
    ...
    #       both of course.)
    def __init__(self, car = None, wheel_location = None, serial_number):
        self.car = car
    ...
    def install_tire(self):
        ...
        print('cleaned tpms: ', 
              self.car.tpms[self.wheel_location].get_serial_number, 
              '.')
    ...
    def read_tire_pressure(self):
        ...
        return self.car.tpms[self.wheel_location].get_pressure()
...
engine = Engine()
# TODO: Rewrite the following after moving tpms to the 'Wheel' class.
wheels = [tpms(None, 'front-right'), tpms(None, 'front-left'), 
          tpms(None, 'back-right'), tpms(None, 'back-left')]
